...
- Completed in the pointer-freeze increment: a failed tap enable restores the default global cursor-suppression interval, and a failed timeout recovery explicitly unfreezes the pointer instead of leaving the freeze state armed.
