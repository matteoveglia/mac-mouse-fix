...
- Remaining runtime work: exercise rapid enable/disable, timeout recovery, helper restart, permission revocation, sleep/wake, and active pointer-freeze/modified-drag teardown in a signed build.
